package Geo::OSM::Overpass::Plugin::FetchPedestrianCrossings;
...
Geo::OSM::Overpass::Plugin::FetchPedestrianCrossings - Plugin for L<Geo::OSM::Overpass> to fetch bus stop data in given area
...
its C<gorun()> method.
    ...
    # a bounding box (specify bottom-left and top-right corner - LAT,LON convention)
    $bbox->bounded_by(35.157610, 33.339986, 35.157771, 33.340864);
    ...
    # <meta osm_base="2019-05-15T21:54:02Z"/>
    # 
    #   <node id="4219339742" lat="35.1576342" lon="33.3403326">
    #     <tag k="highway" v="crossing"/>
    #   </node>
    #   <node id="4219339748" lat="35.1577222" lon="33.3403767">
    #     <tag k="highway" v="crossing"/>
    #   </node>
    # 
    # </osm>
...
Please report any bugs or feature requests to C<bug-geo-osm-overpass-plugin-FetchPedestrianCrossings at rt.cpan.org>, or through
the web interface at L<https://rt.cpan.org/NoAuth/ReportBug.html?Queue=Geo-OSM-Overpass-Plugin-FetchPedestrianCrossings>.  I will be notified, and then you'll
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Geo::OSM::Overpass::Plugin::FetchPedestrianCrossings
...
L<https://rt.cpan.org/NoAuth/Bugs.html?Dist=Geo-OSM-Overpass-Plugin-FetchPedestrianCrossings>

=item * AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/Geo-OSM-Overpass-Plugin-FetchPedestrianCrossings>

=item * CPAN Ratings

L<https://cpanratings.perl.org/d/Geo-OSM-Overpass-Plugin-FetchPedestrianCrossings>

=item * Search CPAN

L<https://metacpan.org/release/Geo-OSM-Overpass-Plugin-FetchPedestrianCrossings>
...
=cut
1; # End of Geo::OSM::Overpass::Plugin::FetchPedestrianCrossings
